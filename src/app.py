...
def create_app():
    ...
    def accounts():
        try:
            ...
            if next_cursor and count_filter.get(sort):
                del count_filter[sort]
            total_results = db.accounts.count_documents(count_filter)
    ...
    app.logger.info("found %d docs", init_result)
